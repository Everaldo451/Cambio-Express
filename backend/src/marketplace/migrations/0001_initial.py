# Generated by Django 5.1 on 2025-04-21 20:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offert', models.ForeignKey(limit_choices_to={'company': models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='selled_offerts', to='api.company')}, on_delete=django.db.models.deletion.PROTECT, to='marketplace.offert')),
